...
The findings are striking: over six decades of nearly uninterrupted GDP growth, housing affordability consistently worsened.

## Key Findings

- Real GDP and the Median Multiple are strongly positively correlated (r=0.794, R²=0.631, n=248)
...
- By 2024 Q4 the Median Multiple remained elevated at 3.90, well above the affordable threshold of 3.0
...
OLS regression in this case functions as descriptive of a trend of two series moving together rather than inferential. Both GDP and the Median Multiple are non-stationary series — standard OLS on non-stationary data can produce spurious results. The Durbin-Watson statistic of 0.303 confirms strong autocorrelation in the residuals, consistent with this interpretation. A companion cointegration analysis (Piece 2) is planned to address stationarity formally.
